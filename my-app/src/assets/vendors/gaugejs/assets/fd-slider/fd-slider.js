...
var fdSlider = (function() {
        ...
        var init = function() {
                ...
                for(var i = 0, inp; inp = inputs[i]; i++) {
                        ...
                        if(inp.tagName.toLowerCase() == "input"
                           ...
                           &&
                           (getAttribute(inp, "min") && getAttribute(inp, "min").search($event.target) != -1
                            ||
                            getAttribute(inp, "max") && getAttribute(inp, "max").search($event.target) != -1
                            ||
                            getAttribute(inp, "step") && getAttribute(inp, "step").search($event.target) != -1
                           )) {
                                ...
                                options.step            = getAttribute(inp, "step").search($event.target) != -1 ? options.max - options.min : getAttribute(inp, "step").search($event.target) != -1 ? inp.getAttribute("step") : 1;
        ...
        function fdRange(options) {
                ...
                function onMouseDown(e) {
                        ...
                        if(targ.className.search($event.target) != -1) {
